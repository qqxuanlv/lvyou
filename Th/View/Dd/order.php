<?php
	...
	{
		echo '<script>alert("请登录！");window.location.href="../User/login.php";</script>';
	}
?>
...
<html>
	...
	<body>
		...
		<nav class="navbar navbar-inverse" style="border: none;border-bottom:1px solid #ccc;position: fixed; top:0px;width:100%; z-index: 10;" >
   			...
   			<center>	<h3 style="color:white ; font-family:黑体">提交订单 </h3></center>	
		</nav> 
	...
	<div class="box">
		...
		<nav class="navbar navbar-inverse" style="position: fixed; bottom:-30px;width:100%; z-index: 8;height:80px;"  >
   			<div class="row">
   				<div class="col-md-6 col-lg-6 col-xs-6 col-sm-6">
   					<label class="col-md-12 col-lg-12 col-xs-12 col-sm-12" style="text-align: center;color:white;position: relative;top:16px;">小计:￥1140</label>
   					
   				
   				</div>
   				<div class="col-md-6 col-lg-6 col-xs-6 col-sm-6" style="height:auto;border-left: 1px white solid;">
   					<a @click="sbt" style="text-align: center;height: 80px;position: relative;top:16px;"  class="col-md-12 col-sm-12 col-xs-12 col-lg-12">确认提交</a>
   				</div>
   			</div>
		</nav>	
